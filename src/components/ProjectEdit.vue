    ...
    <!-- <router-link :to="{ name: 'ReplaceDialog' }">Перейти на страницу Replace</router-link> -->
      ...
      <div class="canvasPanel">
        <div class="buttunsGrid">
          ...
          <button class="btnss" @click="addImg">
            <img class="btnIcon" :src="require('/src/assets/circle.png')" />
            <!--добавить картинку-->
          </button>
        </div>
        ...
        <div class="" style="display: flex; flex-direction: row">
          <div class="" style="margin-right: 20px">
            ...
            <div class="textareaQuery">
              <textarea class="textAr" id="" cols="30" rows="10">
          ...
          <div v-if="selectedLayer && selectedLayer.object">
            <div style="background-color: #90f7fe">
              ...
              <div v-if="selectedLayer.object.type === 'textbox'">
                <label>Font:</label><br />
                <input type="text" v-model="layerFont" id="font" /><br />
              ...
              <button class="btnss" @click="saveSettings">
    ...
    methods: {
      ...
      selectLayer(layer) {
        if (layer.object) {
          ...
          if (layer.object.type === "textbox") {
            ...
            // У изображения нет цвета заливки и непрозрачности
            this.layerColor = null;
            this.layerOpacity = null;
            this.layerFont = null;
      ...
      handleSelection(e) {
        ...
        if (selectedLayer) {
          ...
          this.layerWidth =
            selectedLayer.object.width * selectedLayer.object.scaleX;
          this.layerHeight =
            selectedLayer.object.height * selectedLayer.object.scaleY;
          this.layerName = selectedLayer.name;
          this.layerColor = selectedLayer.object.fill;
          this.layerOpacity = selectedLayer.object.opacity;
          this.layerFont = selectedLayer.object.font;
      ...
      saveSettings() {
        if (this.selectedLayer) {
          const object = this.selectedLayer.object;
          this.selectedLayer.name = this.layerName; // Сохраняем введенное имя слоя
